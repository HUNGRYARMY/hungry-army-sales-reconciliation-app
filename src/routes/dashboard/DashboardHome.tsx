...
type Section = 'cash' | 'shrinkage' | 'discounts' | 'spot-audit' | 'flavors' | 'reports' | 'admin'
...
export function DashboardHome() {
  ...
  return (
    <AppShell>
      ...
      {section === 'reports' && (
        <ReportsView branches={branches.data ?? []} branchId={branchId} onBranchChange={setBranchId} />
      )}
